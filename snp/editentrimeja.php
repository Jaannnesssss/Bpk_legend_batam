<?php 
        ...
        if(isset($_POST['update'])){
            $updatednama_booker = $_POST['booker_name'];
            $query = "UPDATE meja SET nama_booker ='$updatednama_booker' WHERE id_meja ='$id_meja'";
                        ...
                        <div class="col-sm-6 offset-sm-3" style="background-color:white; border-radius: 0px 0px 10px 10px; padding-right:30px; padding-left:30px; padding-bottom:15px";>
                            <form action="" method="POST">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="exampleFormControlSelect1" name="Meja_option" type="readonly" disabled>                                        
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <select class="form-control" name="statusmeja_option" type="readonly" disabled>
