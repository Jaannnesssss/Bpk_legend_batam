            ...
            <div class="row">
                ...
                <div class="col align-self-center" style="vertical-align:bottom;">
                    ...
                    <form style="width:50%;">
                        ...
                        <button type="submit" class="btn btn-primary p-2" style="color:white; background-color:#A71E22; width:270px; font-size:26px; border-radius:10px">Sign up</button>
                        <small id="emailHelp" class="form-text text-muted">Already Have An Account? <b><a href="#" style="color:#A71E22;">Log in</a></b></small>
                    </form>
                </div>
            </div>
        </div>
